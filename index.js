          ...
          try{
            ...
            if(res.length){
                ...
                for(let i = 0; i < res.length; i++) {
                    str += res[i].email + ' - ' + ((res[i].discord_id)?'<@'+res[i].discord_id+'>':'Not Linked') + " - " + (res[i].endDate!==null?res[i].endDate.toString().split('(')[0]:"null") + '\n'
                  }
